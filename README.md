...
### Getting The Data
    ...
    on The Verge's website. Within this spider class are a set of instructions to parse html response for 4 attributes:
        ...
        3. Writer's Name
        4. Text 
    The spider can be accessed in the data_collection [directory](https://github.com/jacksonbull87/Topic-Modeling-TV-Shows-NLP-Text-Analysis-/tree/master/data_collection)
